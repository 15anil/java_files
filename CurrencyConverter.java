...
public class CurrencyConverter {
	...
	public static void Riyal_to_other(double amt) {
		System.out.println("1 Riyal = " + 21.79 + " Ruppee ");
		System.out.println();
		System.out.println(amt + " Riyal = " + (amt * 21.79) + " Ruppee");
		System.out.println();
		...
		System.out.println("1 Riyal = " + 0.24 + " Euro");
		System.out.println();

		System.out.println(amt + " Riyal = " + (amt * 0.24) + " Euro");
	}
}